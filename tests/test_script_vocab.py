...
class TestScriptVocab(unittest.TestCase):
    ...
    def test_translate_dictionary(self, sleep_mock, translate_chunk_mock):
        ...
        result = self.sv.translate_dictionary(test_dict, input_lang, target_lang, 3)

        translate_chunk_mock.assert_called_with(
            ["palabra1", "palabra2", "palabra3"], input_lang, target_lang
        )
    ...
    def test_translate_dictionary_waiting(self, sleep_mock, translate_chunk_mock):
        ...
        result = self.sv.translate_dictionary(test_dict, input_lang, target_lang, 2)
    ...
    def test_run_with_empty_input(
        ...
        """
        This test is to make sure that the script doesn't crash when there is no input.
        """
        create_dictionary_mock.return_value = {}
        translate_dictionary_mock.return_value = {}
        self.sv.all_words = [""]
    ...
    def test_save_output_to_file(self):
        ...
        with open(TEMP_TEST_FILE_SAVE, "r", encoding="utf-8") as file:
            self.assertEqual(
                file.read().strip(),
    ...
    def test_get_output_as_json(self):
        ...
        self.assertEqual(
            self.sv.get_output_as_json(),
            [
                {
                    "occurrences": "5",
                    "original_text": "palabra1",
